<%-- 
    Document   : EditProd
    Created on : Feb 18, 2017, 7:31:12 PM
    Author     : samuel
--%>
        ...
        <hr />
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group"> Product:
                        <div class="col-mod-3">
                            <input name="txtProdName" type="text" Class="form-control">
                        </div>
                    </div>

                    <div class="form-group">Product Description:
                    <div class="col-mod-3">
                        <input name="txtProdDesc" type="text" Class="form-control">
                    </div>
                    </div>
                    
                    <div class="form-group">Product Code:
                    <div class="col-mod-3">
                        <input name="txtProdCode" type="text" maxlength="4" Class="form-control">
                    </div>
                    </div>
                    
                    <div class="form-group">Manufacturer:
                    <div class="col-mod-3">
                        <input name="txtProdManuf" type="text" Class="form-control">
                    </div>
                    </div>
                    
                    <div class="form-group">Expiry Date:                    
                    <div class="col-mod-3">
                        <input name="txtProdExpDate" type="text" id="datepicker" Class="form-control">            
                    </div>
                    </div>
