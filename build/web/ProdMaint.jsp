<%-- 
    Document   : ProdMaint
    Created on : Feb 8, 2017, 11:12:47 PM
    Author     : samuel
--%>
        ...
        <hr/>
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group"> Product:
                        <div class="col-mod-3">
                            <input name="txtProdName" type="text" Class="form-control" placeholder="Product Name">
                        </div>
                    </div>

                    <div class="form-group">Product Description:
                    <div class="col-mod-3">
                        <input name="txtProdDesc" type="text" Class="form-control" placeholder="Product Description">
                    </div>
                    </div>
                    
                    <div class="form-group">Product Code:
                    <div class="col-mod-3">
                        <input name="txtProdCode" type="text" maxlength="4" Class="form-control" placeholder="Product Code">
                    </div>
                    </div>
                    
                    <div class="form-group">Manufacturer:
                    <div class="col-mod-3">
                        <input name="txtProdManuf" type="text" Class="form-control" placeholder="Manufacturer">
                    </div>
                    </div>
                    
                    <div class="form-group">Expiry Date:                    
                    <div class="col-mod-3">
                        <input name="txtProdExpDate" type="text" id="datepicker" Class="form-control" placeholder="Expiry Date">            
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-mod-6">
                        <input type="submit" name="btnCreateProd" value="Create Product" class="btn btn-success">
                        </div>
                    </div>
