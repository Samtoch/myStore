<%-- 
    Document   : DailySales
    Created on : Feb 16, 2017, 8:46:48 PM
    Author     : samuel
--%>
...
<form method="POST" action="">
        ...
        <table style=" align-items: flex-start" class="table table-striped table-bordered table-hover" id="itemTable">
                <thead>
                    <tr>
                        <th style="width: 8px">Reference Id</th>
                        <th>Name</th>                    
                        <th style="width: 6px">Product</th>
                        <th style="width: 6px">Selling Price</th>
                        <th style="width: 6px">Total Quantity</th>
                        <th style="width: 6px">Quantity Left</th>
                        <th style="width: 6px">Rec Status</th>
                        <th>Description</th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
                        <th style="width: 6px">Reference Id</th>
                        <th>Name</th>
                        <th style="width: 6px">Product</th>
                        <th style="width: 6px">Selling Price</th>
                        <th style="width: 6px">Total Quantity</th>
                ...
                <tbody>
                    <c:forEach items="${DailySales}" var="p">
                    <tr>
                    <td> <a href="UpdateSale?itemRef=${p.itemRef}">${p.itemRef}</a></td>
                    <td>${p.itemName}</td>
