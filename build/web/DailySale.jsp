<%-- 
    Document   : DailySale
    Created on : Feb 22, 2017, 8:40:15 PM
    Author     : samuel
--%>
...
<!--form Open tag-->
            <div id="wrapper">
                ...
                <div class="container">
                    <!--<div class="container">-->
                    <h1>Manage Daily Sales</h1>
                    <hr />

                <form method="POST" action="DailySale">
                    <c:forEach items="${getItemsById}" var="p">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <div class="thumbnail">
                                    ...
                                    <div class="form-group">Price:                    
                                        <div class="col-mod-4">
                                            <input maxlength="10" name="txtPrice" Class="form-control" value="${p.sellPrice}">
                                            <input type="hidden" name="txtNormalPrice" Class="form-control" value="${p.sellPrice}">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-xs-6">
                                    <div class="form-group">Quantity:                   
                                        <div class="col-mod-4">
                                            <input maxlength="10" name="txtQty" type="number" min="0" value="1" Class="form-control">   
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group"> Item:
                                            <div class="col-mod-3">
                                                <input  readonly="true" name="txtItemName" value="${p.itemName}" Class="form-control">
                                            </div>
                                    </div>
                                    <div class="form-group">Product:
                                        <div class="col-mod-3">
                                            <input readonly="true" name="txtProduct" value="${p.product}" Class="form-control">
                                        </div>
                                    </div>  
                                    
                                    <div class="form-group">Item Description:
                                        <div class="col-mod-3">
                                            <input readonly="true" name="txtItemDesc" value="${p.itemDesc}" type="text" Class="form-control">
                                        </div>
                                    </div>                

                                    <div class="form-group">Manufacturer:
                                        <div class="col-mod-3">
                                            <input readonly="true" name="txtManufacturer" value="${p.manufacturer}" type="text" Class="form-control">
                                        </div>
                                    </div>

                                    <div class="form-group">Expiry Date:                    
                                        <div class="col-mod-3">
                                            <input readonly="true" name="txtExpDate" value="${p.expiryDate}" type="text" id="datepicker" Class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">Record Status:                    
                                        <div class="col-mod-3">
                                            <input readonly="true" name="txtRecStat" value="${p.recordStatus}" type="text" id="datepicker" Class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-4"> 
                                ...
                                <div class="row">   
                                    ...
                                    <div class="form-group">Quantity Left:                    
                                        <div class="col-mod-4">
                                            <input readonly="true" name="txtQtyLeft" value="${p.qtyLeft}"  Class="form-control">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-xs-6">
                                    <div class="form-group">Total Quantity:                    
                                        <div class="col-mod-3">
                                            <input readonly="true" name="txtTotalQty" value="${p.totalQty}"  Class="form-control">
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                    
                                    <div class="form-group">Item Reference Id:
                                        <div class="col-mod-3">
                                            <input readonly="true"  name="txtItemRef" value="${p.itemRef}" type="text" Class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">Cost Price:                    
                                        <div class="col-mod-3">
                                            <input readonly="true"  name="txtCostPricePerItem" value="${p.costPrice}" Class="form-control">
                                        </div>
                                    </div>

                                    <div class="form-group">Selling Price:                    
                                        <div class="col-mod-3">
                                            <input readonly="true" name="txtSellingPricePerItem" value="${p.sellPrice}" type="text" Class="form-control">
                                        </div>
                                    </div>
                                    

                                    <div class="form-group">User Created:                    
                                        <div class="col-mod-3">
                                            <input readonly="true" name="txtUserCreated" value="${p.userCreated}" type="text" Class="form-control">
                                        </div>
                                    </div>

                                    <div class="form-group">Date Created:                    
                                        <div class="col-mod-3">
                                            <input readonly="true" name="txtDateCreated" value="${p.dateCreated}" type="text" Class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-mod-3">
                                            <input type="submit" name="btnAddItem" value="Register Sale" class="btn btn-success form-control">
                                        </div>
                                    </div>
