<%-- 
    Document   : index
    Created on : Feb 3, 2017, 10:12:37 PM
    Author     : samuel
--%>
...
<html>
    <head>
        ...
        <link href="style/css/Custom-Sc.css" type="text/css" rel="stylesheet"/>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="SignUp.jsp" style="color: green"> <span> <img alt="mylogo" src="style/Images/Firefox-logo.svg.png" height="30"/> </span>eStore</a>
                </div>
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"> <a href="index.jsp" style="color: green">Home</a> </li>
                        <li> <a href="#" style="color: green" >About</a> </li>
                        <li data-toggle="popover" id="popContact"><a href="#" data-toggle="modal" data-target="#ContactUs" style="color: green">Contact Us</a> </li>
                        ...
                        <li data-toggle="popover" id="popContact"><a href="#" data-toggle="modal" data-target="#signup-modal" style="color: green">Sign Up</a> </li>
                        <li data-toggle="popover" id="popContact"><a href="#" data-toggle="modal" data-target="#signIn-modal" style="color: green">Sign In<b class="glyphicon glyphicon-user" style="color: white"></b></a> </li>
                    </ul>
                </div>
            </div>
        </div>
...
<form method="POST" action="Login">
    ...
    <div class="container" id="wrapper">
        <div class="panel panel-default">
            <div class="panel-heading" style="margin: 10px; height:80px; width: auto; font-family: cursive; text-align: left; color: green ">
                <br>
