<%-- 
    Document   : EditItems
    Created on : Feb 12, 2017, 2:38:12 PM
    Author     : samuel
--%>
                ...
                <form method="POST" action="UpdateItem">
                    <c:forEach items="${getItemsById}" var="p">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <div class="thumbnail">
                                    <div class="form-group">Item Reference Id:
                                        <div class="col-mod-3">
                                            <input name="txtItemRef" value="${p.itemRef}" type="text" Class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group"> Item:
                                        <div class="row">
                                            <div class="col-xs-9">
                                                <input name="txtItemName" value="${p.itemName}" type="text" Class="form-control">
                                            </div>
                                            <div class="col-xs-3">
                                                <select name="txtItemStat">
                                                    <option value="${p.itemStatus}">${p.itemStatus}</option> 
                                    ...
                                    <div class="form-group">Product:
                                        <div class="col-mod-3">
                                            <input name="txtProduct" value="${p.product}" type="text" Class="form-control">
                                        </div>
                                    </div>  
                                    
                                    <div class="form-group">Item Description:
                                        <div class="col-mod-3">
                                            <input name="txtItemDesc" value="${p.itemDesc}" type="text" Class="form-control">
                                        </div>
                                    </div>                

                                    <div class="form-group">Manufacturer:
                                        <div class="col-mod-3">
                                            <input name="txtManufacturer" value="${p.manufacturer}" type="text" Class="form-control">
                                        </div>
                                    </div>

                                    <div class="form-group">Expiry Date:                    
                                        <div class="col-mod-3">
                                            <input name="txtExpDate" value="${p.expiryDate}" type="text" id="datepicker" Class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">Record Status:                    
                                        <div class="col-mod-3">
                                            <input name="txtRecStat" value="${p.recordStatus}" type="text" id="datepicker" Class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-4"> 
                                <div class="thumbnail">
                                    <div class="form-group">Price Per Item:                    
                                        <div class="col-mod-3">
                                            <input name="txtCostPricePerItem" value="${p.costPrice}" type="text" Class="form-control">
                                        </div>
                                    </div>

                                    <div class="form-group">Projected Selling Price Per Item:                    
                                        <div class="col-mod-3">
                                            <input name="txtSellingPricePerItem" value="${p.sellPrice}" type="text" Class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">Quantity:                    
                                        <div class="col-mod-3">
                                            <input name="txtQuantity" value="${p.totalQty}" type="text" Class="form-control">
                                        </div>
                                    </div>
                                        
                                    <div class="form-group">User Created:                    
                                        <div class="col-mod-3">
                                            <input name="txtUserCreated" value="${p.userCreated}" type="text" Class="form-control">
                                        </div>
                                    </div>

                                    <div class="form-group">Date Created:                    
                                        <div class="col-mod-3">
                                            <input name="txtDateCreated" value="${p.dateCreated}" type="text" Class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-mod-3">
                                            <input type="submit" name="btnAddItem" value="Update Item" class="btn btn-success form-control">
                                        </div>
                                    </div>
