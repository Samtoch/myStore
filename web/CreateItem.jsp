<%-- 
    Document   : CreateItem
    Created on : Feb 11, 2017, 10:55:37 PM
    Author     : samuel
--%>
                ...
                <div class="col-xs-4">
                    <div class="thumbnail">
                            ...
                            <div class="form-group">
                                <%
                                    try {
                                        ...
                                        Connection Conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mystock", "root", "password");
                                        String sqlSelect = "SELECT product_group FROM mystock.product_group";
                                        Statement creatStmt = Conn.createStatement();
                                        ResultSet resultSet;
                                        resultSet = creatStmt.executeQuery(sqlSelect);
                                %>
                                <select id="product" name="txtProduct">
                            ...
                            <div class="form-group"> Item:
                                <div class="row">
                                    <div class="col-xs-9">
                                        <input name="txtItemName" type="text" Class="form-control" placeholder="Item Name">
                                    </div>
                                    <div class="col-xs-3">
                                        <select name="txtItemStat" id="txtItemStat">
                            ...
                            <div class="form-group">Item Description:
                                <div class="col-mod-3">
                                    <input name="txtItemDesc" type="text" Class="form-control" placeholder="Item Description">
                                </div>
                            </div>                

                            <div class="form-group">Manufacturer:
                                <div class="col-mod-3">
                                    <input name="txtManufacturer" type="text" Class="form-control" placeholder="Manufacturer">
                                </div>
                            </div>

                            <div class="form-group">Expiry Date:                    
                                <div class="col-mod-3">
                                    <input name="txtExpDate" type="text" id="datepicker" Class="form-control" placeholder="Expiry Date">
                                </div>
                            </div>
                    </div>
                </div>
                ...
                <div class="thumbnail">
                    <br><br><br>
                            <div class="form-group">Quantity:                    
                                <div class="col-mod-3">
                                    <input name="txtQuantity" type="text" Class="form-control" placeholder="Quantity">
                                </div>
                            </div>

                            <div class="form-group">Price Per Item:                    
                                <div class="col-mod-3">
                                    <input name="txtCostPricePerItem" type="text" Class="form-control" placeholder="Cost Price Per Item">
                                </div>
                            </div>

                            <div class="form-group">Projected Selling Price Per Item:                    
                                <div class="col-mod-3">
                                    <input name="txtSellingPricePerItem" type="text" Class="form-control" placeholder="Projected Selling Price">
                                </div>
                            </div>
                            <br>
                            <div class="form-group">
                                ...
                                <div class="col-mod-3">
                                    <input type="submit" name="btnAddItem" value="Add Item" class="btn btn-success form-control">
                                </div>
                            </div>
