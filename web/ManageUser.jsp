<%-- 
    Document   : ManageUser
    Created on : Feb 17, 2017, 9:13:01 PM
    Author     : samuel
--%>
...
<form method="POST" action="ProductMaint">
        ...
        <table style=" border: 20px" class="table table-striped table-bordered table-hover" id="itemTable">
                <thead>
                    <tr>
                        <th>Reference Id</th>
                        <th>Name</th>
                ...
                <tbody>
                    <c:forEach items="${ViewItems}" var="p">
                    <tr>
                    <td> <a href="EditItems?itemRef=${p.itemRef}">${p.itemRef}</a></td>
                    <td>${p.itemName}</td>
                    <td>${p.itemDesc}</td>
                    <td>${p.product}</td>
